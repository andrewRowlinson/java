    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            if (command.equals("points")) {
                ...
                System.out.print("Which players statistics are needed? ");
                String playerWanted = reader.nextLine();
                NHLStatistics.searchByPlayer(playerWanted);
                ...
                String clubWanted = reader.nextLine();
                NHLStatistics.sortByPoints();
                NHLStatistics.teamStatistics(clubWanted);
            }
